...
> 📌 **版本口径提醒（2026-08-20）**：本 wiki 中的组件版本号以仓库当前锁定为准（如 Pigsty v4.4.0、PostgreSQL 18）。官方在线文档（pigsty.cc）可能已更新到更新版本（如 v4.5），其中与本项目机制相关的结论通用；其余文档中的版本号不逐一同步修改，以本项目部署时的实际锁定版本为准。
