...
echo "    APISIX:        http://localhost:9080 (唯一对外入口)"
echo "    APISIX Admin:  http://localhost:9180 (内置 Dashboard: http://localhost:9180/ui；仅内网管理)"
echo "    PostgREST:     http://localhost:3001"
echo "    Logto:         http://localhost:3001 (Console: http://localhost:3002)"
