...
CREATE INDEX IF NOT EXISTS idx_role_api_api ON sys_role_api(api_id);
...
CREATE INDEX IF NOT EXISTS idx_session_user ON sys_user_session(user_id, is_used);
CREATE INDEX IF NOT EXISTS idx_session_expiry ON sys_user_session(expired_at);
CREATE INDEX IF NOT EXISTS idx_session_hash ON sys_user_session(refresh_token_hash);
CREATE INDEX IF NOT EXISTS idx_session_tenant ON sys_user_session(tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_blacklist_expired ON sys_token_blacklist(expired_at);
CREATE INDEX IF NOT EXISTS idx_blacklist_user ON sys_token_blacklist(user_id);

-- ==============================================================================
-- 14. 角色分配审批流表
-- ==============================================================================
CREATE TABLE IF NOT EXISTS sys_user_role_request (
    id UUID PRIMARY KEY DEFAULT uuidv7(),
...
CREATE INDEX IF NOT EXISTS idx_role_request_status ON sys_user_role_request(status);
CREATE INDEX IF NOT EXISTS idx_role_request_tenant ON sys_user_role_request(tenant_id);
CREATE INDEX IF NOT EXISTS idx_role_request_applicant ON sys_user_role_request(applicant_id);
