-- api_v1/platform/rpc/rpc_list_cron_jobs.sql
-- FUNCTION: api_v1_platform.rpc_list_cron_jobs（17 号文档归位：迁移 021_cron_rpc_geolite2.sql 删定义段，本文件为唯一权威）
-- 回放终态: 021_cron_rpc_geolite2.sql；幂等写法（§9 模板）

CREATE OR REPLACE FUNCTION api_v1_platform.rpc_list_cron_jobs()
...
END;
$$;
GRANT EXECUTE ON FUNCTION api_v1_platform.rpc_list_cron_jobs() TO authenticated;
