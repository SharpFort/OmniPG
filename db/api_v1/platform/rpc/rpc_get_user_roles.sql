-- api_v1/platform/rpc/rpc_get_user_roles.sql
-- FUNCTION: api_v1_platform.rpc_get_user_roles（17 号文档归位：迁移 051_logto_guard_cleanup.sql 删定义段，本文件为唯一权威）
-- 回放终态: 051_logto_guard_cleanup.sql；幂等写法（§9 模板）

CREATE OR REPLACE FUNCTION api_v1_platform.rpc_get_user_roles(p_user_id text, p_org_id text DEFAULT NULL)
RETURNS json
