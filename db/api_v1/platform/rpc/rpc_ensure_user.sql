...
END;
$$;
COMMENT ON FUNCTION api_v1_platform.ensure_user() IS '登录 JIT 兜底建档 + 角色镜像精确对齐（035: user_role 随 claims 全量覆盖；049 D5/D6: global/org 分段增量对齐，角色不变零写入，保留 created_at，全局 token 不清 org 段）';
