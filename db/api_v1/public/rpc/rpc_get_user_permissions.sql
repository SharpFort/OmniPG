...
CREATE OR REPLACE FUNCTION api_v1_public.get_user_permissions()
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
...
END;
$$;
COMMENT ON FUNCTION api_v1_public.get_user_permissions() IS '获取当前用户的 API 权限列表（基于 Casbin 策略）';
GRANT EXECUTE ON FUNCTION api_v1_public.get_user_permissions() TO authenticated;
