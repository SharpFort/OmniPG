-- api_v1/public/rpc/rpc_assign_user_positions.sql
-- FUNCTION: api_v1_public.rpc_assign_user_positions（17 号文档归位：迁移 024_admin_crud_rpc.sql 删定义段，本文件为唯一权威）
...
END $$;
GRANT EXECUTE ON FUNCTION api_v1_public.rpc_assign_user_positions(text, uuid[], uuid) TO authenticated;
