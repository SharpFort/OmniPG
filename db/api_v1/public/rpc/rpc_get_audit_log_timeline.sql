...
CREATE OR REPLACE FUNCTION api_v1_public.get_audit_log_timeline(
...
END;
$$;
COMMENT ON FUNCTION api_v1_public.get_audit_log_timeline(timestamp, timestamp) IS '获取审计时间线（按天聚合）';
GRANT EXECUTE ON FUNCTION api_v1_public.get_audit_log_timeline(timestamp, timestamp) TO authenticated;
