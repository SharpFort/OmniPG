-- api_v1/public/rpc/rpc_webhook_logto.sql
-- FUNCTION: api_v1_public.webhook_logto（17 号文档归位：迁移 050_suspension_sync.sql 删定义段，本文件为唯一权威）
-- 回放终态: 050_suspension_sync.sql；幂等写法（§9 模板）

CREATE OR REPLACE FUNCTION api_v1_public.webhook_logto(jsonb)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
