...
-- 034: 由 api_v1_public.user_role 更名而来（消除与 platform.user_role 表同名冲突）
...
COMMENT ON VIEW api_v1_public.user_tenants IS '用户-组织成员关系视图（Logto 镜像：user_tenants；034 由 user_role 更名，消除与 platform.user_role 表同名冲突）';
