-- api_v1/public/views/v_login_log.sql
-- VIEW: api_v1_public.v_login_log（17 号文档归位：迁移 026_view_sys_cleanup.sql 删定义段，本文件为唯一权威）
-- 回放终态: 026_view_sys_cleanup.sql；幂等写法（§9 模板）

CREATE OR REPLACE VIEW api_v1_public.v_login_log AS
