...
DROP VIEW IF EXISTS api_v1_sys.iam_role_menu CASCADE;
CREATE OR REPLACE VIEW api_v1_sys.iam_role_menu AS
...
COMMENT ON VIEW api_v1_sys.iam_role_menu IS '角色-菜单关联视图（Logto 镜像：iam_role_menu）';
