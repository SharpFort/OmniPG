-- src/platform/functions/sync_organization_role_delete.sql
-- FUNCTION: platform.sync_organization_role_delete（17 号文档归位：迁移 048_organization_role_mirror.sql 删定义段，本文件为唯一权威）
